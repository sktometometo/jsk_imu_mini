#ifndef _ROS_hydra_gap_passing_PlanningMode_h
#define _ROS_hydra_gap_passing_PlanningMode_h
...
namespace hydra_gap_passing
{
  ...
  class PlanningMode : public ros::Msg
  {
    ...
    const char * getType(){ return "hydra_gap_passing/PlanningMode"; };
