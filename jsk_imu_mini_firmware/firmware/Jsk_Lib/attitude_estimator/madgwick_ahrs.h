...
public:
  ...
  virtual void estimation()
  {
    ...
    accGyroMagEstimate(gyro_b_[0], gyro_b_[1], gyro_b_[2], acc_b_[0], acc_b_[1], acc_b_[2], mag_b_[0], mag_b_[1],
                       mag_b_[2]);
#endif
...
private:
  ...
  void accGyroMagEstimate(float gx, float gy, float gz, float ax, float ay, float az, float mx, float my, float mz)
  {
    ...
    if (!((ax == 0.0f) && (ay == 0.0f) && (az == 0.0f)))
    {
      ...
      hx = mx * q0q0 - _2q0my * q_[3] + _2q0mz * q_[2] + mx * q1q1 + _2q1 * my * q_[2] + _2q1 * mz * q_[3] - mx * q2q2 -
           mx * q3q3;
      hy = _2q0mx * q_[3] + my * q0q0 - _2q0mz * q_[1] + _2q1mx * q_[2] - my * q1q1 + my * q2q2 + _2q2 * mz * q_[3] -
           my * q3q3;
      _2bx = sqrt(hx * hx + hy * hy);
      _2bz = -_2q0mx * q_[2] + _2q0my * q_[1] + mz * q0q0 + _2q1mx * q_[3] - mz * q1q1 + _2q2 * my * q_[3] - mz * q2q2 +
             mz * q3q3;
      _4bx = 2.0f * _2bx;
      _4bz = 2.0f * _2bz;
      ...
      s0 = -_2q2 * (2.0f * q1q3 - _2q0q2 - ax) + _2q1 * (2.0f * q0q1 + _2q2q3 - ay) -
           _2bz * q_[2] * (_2bx * (0.5f - q2q2 - q3q3) + _2bz * (q1q3 - q0q2) - mx) +
           (-_2bx * q_[3] + _2bz * q_[1]) * (_2bx * (q1q2 - q0q3) + _2bz * (q0q1 + q2q3) - my) +
           _2bx * q_[2] * (_2bx * (q0q2 + q1q3) + _2bz * (0.5f - q1q1 - q2q2) - mz);
      s1 = _2q3 * (2.0f * q1q3 - _2q0q2 - ax) + _2q0 * (2.0f * q0q1 + _2q2q3 - ay) -
           4.0f * q_[1] * (1 - 2.0f * q1q1 - 2.0f * q2q2 - az) +
           _2bz * q_[3] * (_2bx * (0.5f - q2q2 - q3q3) + _2bz * (q1q3 - q0q2) - mx) +
           (_2bx * q_[2] + _2bz * q_[0]) * (_2bx * (q1q2 - q0q3) + _2bz * (q0q1 + q2q3) - my) +
           (_2bx * q_[3] - _4bz * q_[1]) * (_2bx * (q0q2 + q1q3) + _2bz * (0.5f - q1q1 - q2q2) - mz);
      s2 = -_2q0 * (2.0f * q1q3 - _2q0q2 - ax) + _2q3 * (2.0f * q0q1 + _2q2q3 - ay) -
           4.0f * q_[2] * (1 - 2.0f * q1q1 - 2.0f * q2q2 - az) +
           (-_4bx * q_[2] - _2bz * q_[0]) * (_2bx * (0.5f - q2q2 - q3q3) + _2bz * (q1q3 - q0q2) - mx) +
           (_2bx * q_[1] + _2bz * q_[3]) * (_2bx * (q1q2 - q0q3) + _2bz * (q0q1 + q2q3) - my) +
           (_2bx * q_[0] - _4bz * q_[2]) * (_2bx * (q0q2 + q1q3) + _2bz * (0.5f - q1q1 - q2q2) - mz);
      s3 = _2q1 * (2.0f * q1q3 - _2q0q2 - ax) + _2q2 * (2.0f * q0q1 + _2q2q3 - ay) +
           (-_4bx * q_[3] + _2bz * q_[1]) * (_2bx * (0.5f - q2q2 - q3q3) + _2bz * (q1q3 - q0q2) - mx) +
           (-_2bx * q_[0] + _2bz * q_[2]) * (_2bx * (q1q2 - q0q3) + _2bz * (q0q1 + q2q3) - my) +
           _2bx * q_[1] * (_2bx * (q0q2 + q1q3) + _2bz * (0.5f - q1q1 - q2q2) - mz);
