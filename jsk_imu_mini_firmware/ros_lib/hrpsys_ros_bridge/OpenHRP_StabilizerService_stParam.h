  ...
  class OpenHRP_StabilizerService_stParam : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 7) = (u_cop_check_margin.base >> (8 * 7)) & 0xFF;
      ...
      u_cp_check_margin.real = this->cp_check_margin;
      *(outbuffer + offset + 0) = (u_cp_check_margin.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_cp_check_margin.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_cp_check_margin.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_cp_check_margin.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_cp_check_margin.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_cp_check_margin.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_cp_check_margin.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_cp_check_margin.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->cp_check_margin);
      for( uint8_t i = 0; i < 2; i++){
      union {
        double real;
        uint64_t base;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      u_cp_check_margin.base = 0;
      u_cp_check_margin.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_cp_check_margin.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_cp_check_margin.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_cp_check_margin.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_cp_check_margin.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_cp_check_margin.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_cp_check_margin.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_cp_check_margin.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->cp_check_margin = u_cp_check_margin.real;
      offset += sizeof(this->cp_check_margin);
      for( uint8_t i = 0; i < 2; i++){
      union {
        double real;
