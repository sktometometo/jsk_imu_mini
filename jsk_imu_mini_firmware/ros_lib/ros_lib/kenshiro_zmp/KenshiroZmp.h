#ifndef _ROS_kenshiro_zmp_KenshiroZmp_h
#define _ROS_kenshiro_zmp_KenshiroZmp_h
...
namespace kenshiro_zmp
{

  class KenshiroZmp : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "kenshiro_zmp/KenshiroZmp"; };
