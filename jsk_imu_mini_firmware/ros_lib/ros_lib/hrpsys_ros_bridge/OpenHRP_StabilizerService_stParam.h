...
namespace hrpsys_ros_bridge
{
  ...
  class OpenHRP_StabilizerService_stParam : public ros::Msg
  {
    public:
      ...
      double eefm_swing_damping_force_thre[3];
      double eefm_swing_damping_moment_thre[3];
      double eefm_swing_rot_damping_gain[3];
      double eefm_swing_pos_damping_gain[3];
      std_msgs::Float64MultiArray eefm_ee_forcemoment_distribution_weight;
      ...
      uint8_t limb_length_margin_length;
      double st_limb_length_margin;
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 0) = (u_eefm_use_swing_damping.base >> (8 * 0)) & 0xFF;
      ...
      union {
        double real;
        uint64_t base;
      } u_eefm_swing_damping_force_threi;
      u_eefm_swing_damping_force_threi.real = this->eefm_swing_damping_force_thre[i];
      *(outbuffer + offset + 0) = (u_eefm_swing_damping_force_threi.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_eefm_swing_damping_force_threi.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_eefm_swing_damping_force_threi.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_eefm_swing_damping_force_threi.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_eefm_swing_damping_force_threi.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_eefm_swing_damping_force_threi.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_eefm_swing_damping_force_threi.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_eefm_swing_damping_force_threi.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->eefm_swing_damping_force_thre[i]);
      }
      for( uint8_t i = 0; i < 3; i++){
      union {
        double real;
        uint64_t base;
      } u_eefm_swing_damping_moment_threi;
      u_eefm_swing_damping_moment_threi.real = this->eefm_swing_damping_moment_thre[i];
      *(outbuffer + offset + 0) = (u_eefm_swing_damping_moment_threi.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_eefm_swing_damping_moment_threi.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_eefm_swing_damping_moment_threi.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_eefm_swing_damping_moment_threi.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_eefm_swing_damping_moment_threi.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_eefm_swing_damping_moment_threi.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_eefm_swing_damping_moment_threi.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_eefm_swing_damping_moment_threi.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->eefm_swing_damping_moment_thre[i]);
      }
      for( uint8_t i = 0; i < 3; i++){
      union {
        double real;
        uint64_t base;
      } u_eefm_swing_rot_damping_gaini;
      u_eefm_swing_rot_damping_gaini.real = this->eefm_swing_rot_damping_gain[i];
      *(outbuffer + offset + 0) = (u_eefm_swing_rot_damping_gaini.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_eefm_swing_rot_damping_gaini.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_eefm_swing_rot_damping_gaini.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_eefm_swing_rot_damping_gaini.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_eefm_swing_rot_damping_gaini.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_eefm_swing_rot_damping_gaini.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_eefm_swing_rot_damping_gaini.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_eefm_swing_rot_damping_gaini.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->eefm_swing_rot_damping_gain[i]);
      }
      for( uint8_t i = 0; i < 3; i++){
      union {
        double real;
        uint64_t base;
      } u_eefm_swing_pos_damping_gaini;
      u_eefm_swing_pos_damping_gaini.real = this->eefm_swing_pos_damping_gain[i];
      *(outbuffer + offset + 0) = (u_eefm_swing_pos_damping_gaini.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_eefm_swing_pos_damping_gaini.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_eefm_swing_pos_damping_gaini.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_eefm_swing_pos_damping_gaini.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_eefm_swing_pos_damping_gaini.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_eefm_swing_pos_damping_gaini.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_eefm_swing_pos_damping_gaini.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_eefm_swing_pos_damping_gaini.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->eefm_swing_pos_damping_gain[i]);
      }
      ...
      *(outbuffer + offset + 7) = (u_act_capture_pointi.base >> (8 * 7)) & 0xFF;
      ...
      u_cp_offseti.real = this->cp_offset[i];
      *(outbuffer + offset + 0) = (u_cp_offseti.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_cp_offseti.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_cp_offseti.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_cp_offseti.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_cp_offseti.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_cp_offseti.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_cp_offseti.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_cp_offseti.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->cp_offset[i]);
      }
      union {
        double real;
        uint64_t base;
      ...
      *(outbuffer + offset + 0) = (u_use_limb_stretch_avoidance.base >> (8 * 0)) & 0xFF;
      ...
      union {
        double real;
        uint64_t base;
      } u_limb_stretch_avoidance_time_const;
      u_limb_stretch_avoidance_time_const.real = this->limb_stretch_avoidance_time_const;
      *(outbuffer + offset + 0) = (u_limb_stretch_avoidance_time_const.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_limb_stretch_avoidance_time_const.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_limb_stretch_avoidance_time_const.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_limb_stretch_avoidance_time_const.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_limb_stretch_avoidance_time_const.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_limb_stretch_avoidance_time_const.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_limb_stretch_avoidance_time_const.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_limb_stretch_avoidance_time_const.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->limb_stretch_avoidance_time_const);
      for( uint8_t i = 0; i < 2; i++){
      union {
        double real;
        uint64_t base;
      } u_limb_stretch_avoidance_vlimiti;
      u_limb_stretch_avoidance_vlimiti.real = this->limb_stretch_avoidance_vlimit[i];
      *(outbuffer + offset + 0) = (u_limb_stretch_avoidance_vlimiti.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_limb_stretch_avoidance_vlimiti.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_limb_stretch_avoidance_vlimiti.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_limb_stretch_avoidance_vlimiti.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_limb_stretch_avoidance_vlimiti.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_limb_stretch_avoidance_vlimiti.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_limb_stretch_avoidance_vlimiti.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_limb_stretch_avoidance_vlimiti.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->limb_stretch_avoidance_vlimit[i]);
      }
      *(outbuffer + offset++) = limb_length_margin_length;
      *(outbuffer + offset++) = 0;
      *(outbuffer + offset++) = 0;
      *(outbuffer + offset++) = 0;
      for( uint8_t i = 0; i < limb_length_margin_length; i++){
      union {
        double real;
        uint64_t base;
      } u_limb_length_margini;
      u_limb_length_margini.real = this->limb_length_margin[i];
      *(outbuffer + offset + 0) = (u_limb_length_margini.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_limb_length_margini.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_limb_length_margini.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_limb_length_margini.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_limb_length_margini.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_limb_length_margini.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_limb_length_margini.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_limb_length_margini.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->limb_length_margin[i]);
      }
      union {
        double real;
        uint64_t base;
      } u_detection_time_to_air;
      u_detection_time_to_air.real = this->detection_time_to_air;
      *(outbuffer + offset + 0) = (u_detection_time_to_air.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_detection_time_to_air.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_detection_time_to_air.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_detection_time_to_air.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_detection_time_to_air.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_detection_time_to_air.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_detection_time_to_air.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_detection_time_to_air.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->detection_time_to_air);
      for( uint8_t i = 0; i < 2; i++){
      union {
        double real;
        uint64_t base;
      } u_root_rot_compensation_limiti;
      u_root_rot_compensation_limiti.real = this->root_rot_compensation_limit[i];
      *(outbuffer + offset + 0) = (u_root_rot_compensation_limiti.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_root_rot_compensation_limiti.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_root_rot_compensation_limiti.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_root_rot_compensation_limiti.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_root_rot_compensation_limiti.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_root_rot_compensation_limiti.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_root_rot_compensation_limiti.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_root_rot_compensation_limiti.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->root_rot_compensation_limit[i]);
      }
      union {
        bool real;
        uint8_t base;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      u_eefm_swing_damping_force_threi.base = 0;
      u_eefm_swing_damping_force_threi.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_eefm_swing_damping_force_threi.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_eefm_swing_damping_force_threi.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_eefm_swing_damping_force_threi.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_eefm_swing_damping_force_threi.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_eefm_swing_damping_force_threi.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_eefm_swing_damping_force_threi.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_eefm_swing_damping_force_threi.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->eefm_swing_damping_force_thre[i] = u_eefm_swing_damping_force_threi.real;
      offset += sizeof(this->eefm_swing_damping_force_thre[i]);
      }
      for( uint8_t i = 0; i < 3; i++){
      union {
      ...
      u_eefm_swing_damping_moment_threi.base = 0;
      u_eefm_swing_damping_moment_threi.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_eefm_swing_damping_moment_threi.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_eefm_swing_damping_moment_threi.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_eefm_swing_damping_moment_threi.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_eefm_swing_damping_moment_threi.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_eefm_swing_damping_moment_threi.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_eefm_swing_damping_moment_threi.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_eefm_swing_damping_moment_threi.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->eefm_swing_damping_moment_thre[i] = u_eefm_swing_damping_moment_threi.real;
      offset += sizeof(this->eefm_swing_damping_moment_thre[i]);
      }
      for( uint8_t i = 0; i < 3; i++){
      union {
      ...
      u_eefm_swing_rot_damping_gaini.base = 0;
      u_eefm_swing_rot_damping_gaini.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_eefm_swing_rot_damping_gaini.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_eefm_swing_rot_damping_gaini.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_eefm_swing_rot_damping_gaini.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_eefm_swing_rot_damping_gaini.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_eefm_swing_rot_damping_gaini.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_eefm_swing_rot_damping_gaini.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_eefm_swing_rot_damping_gaini.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->eefm_swing_rot_damping_gain[i] = u_eefm_swing_rot_damping_gaini.real;
      offset += sizeof(this->eefm_swing_rot_damping_gain[i]);
      }
      for( uint8_t i = 0; i < 3; i++){
      union {
      ...
      u_eefm_swing_pos_damping_gaini.base = 0;
      u_eefm_swing_pos_damping_gaini.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_eefm_swing_pos_damping_gaini.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_eefm_swing_pos_damping_gaini.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_eefm_swing_pos_damping_gaini.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_eefm_swing_pos_damping_gaini.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_eefm_swing_pos_damping_gaini.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_eefm_swing_pos_damping_gaini.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_eefm_swing_pos_damping_gaini.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->eefm_swing_pos_damping_gain[i] = u_eefm_swing_pos_damping_gaini.real;
      offset += sizeof(this->eefm_swing_pos_damping_gain[i]);
      }
      ...
      u_cp_offseti.base = 0;
      u_cp_offseti.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_cp_offseti.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_cp_offseti.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_cp_offseti.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_cp_offseti.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_cp_offseti.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_cp_offseti.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_cp_offseti.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->cp_offset[i] = u_cp_offseti.real;
      offset += sizeof(this->cp_offset[i]);
      }
      union {
        double real;
      ...
      u_limb_stretch_avoidance_time_const.base = 0;
      u_limb_stretch_avoidance_time_const.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_limb_stretch_avoidance_time_const.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_limb_stretch_avoidance_time_const.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_limb_stretch_avoidance_time_const.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_limb_stretch_avoidance_time_const.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_limb_stretch_avoidance_time_const.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_limb_stretch_avoidance_time_const.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_limb_stretch_avoidance_time_const.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->limb_stretch_avoidance_time_const = u_limb_stretch_avoidance_time_const.real;
      offset += sizeof(this->limb_stretch_avoidance_time_const);
      for( uint8_t i = 0; i < 2; i++){
      union {
        double real;
      ...
      u_limb_stretch_avoidance_vlimiti.base = 0;
      u_limb_stretch_avoidance_vlimiti.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_limb_stretch_avoidance_vlimiti.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_limb_stretch_avoidance_vlimiti.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_limb_stretch_avoidance_vlimiti.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_limb_stretch_avoidance_vlimiti.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_limb_stretch_avoidance_vlimiti.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_limb_stretch_avoidance_vlimiti.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_limb_stretch_avoidance_vlimiti.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->limb_stretch_avoidance_vlimit[i] = u_limb_stretch_avoidance_vlimiti.real;
      offset += sizeof(this->limb_stretch_avoidance_vlimit[i]);
      }
      uint8_t limb_length_margin_lengthT = *(inbuffer + offset++);
      if(limb_length_margin_lengthT > limb_length_margin_length)
        this->limb_length_margin = (double*)realloc(this->limb_length_margin, limb_length_margin_lengthT * sizeof(double));
      offset += 3;
      ...
      union {
        double real;
        uint64_t base;
      } u_st_limb_length_margin;
      u_st_limb_length_margin.base = 0;
      u_st_limb_length_margin.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_st_limb_length_margin.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_st_limb_length_margin.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_st_limb_length_margin.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_st_limb_length_margin.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_st_limb_length_margin.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_st_limb_length_margin.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_st_limb_length_margin.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->st_limb_length_margin = u_st_limb_length_margin.real;
      offset += sizeof(this->st_limb_length_margin);
        memcpy( &(this->limb_length_margin[i]), &(this->st_limb_length_margin), sizeof(double));
      }
      union {
        double real;
        uint64_t base;
      } u_detection_time_to_air;
      u_detection_time_to_air.base = 0;
      u_detection_time_to_air.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_detection_time_to_air.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_detection_time_to_air.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_detection_time_to_air.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_detection_time_to_air.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_detection_time_to_air.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_detection_time_to_air.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_detection_time_to_air.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->detection_time_to_air = u_detection_time_to_air.real;
      offset += sizeof(this->detection_time_to_air);
      for( uint8_t i = 0; i < 2; i++){
      union {
        double real;
      ...
      u_root_rot_compensation_limiti.base = 0;
      u_root_rot_compensation_limiti.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_root_rot_compensation_limiti.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_root_rot_compensation_limiti.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_root_rot_compensation_limiti.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_root_rot_compensation_limiti.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_root_rot_compensation_limiti.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_root_rot_compensation_limiti.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_root_rot_compensation_limiti.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->root_rot_compensation_limit[i] = u_root_rot_compensation_limiti.real;
      offset += sizeof(this->root_rot_compensation_limit[i]);
      }
      union {
        bool real;
