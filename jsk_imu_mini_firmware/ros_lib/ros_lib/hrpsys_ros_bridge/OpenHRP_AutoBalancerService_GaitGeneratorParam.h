...
namespace hrpsys_ros_bridge
{
  ...
  class OpenHRP_AutoBalancerService_GaitGeneratorParam : public ros::Msg
  {
    public:
      ...
      int64_t stride_limitation_type;
      double leg_margin[4];
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 7) = (u_stride_parameteri.base >> (8 * 7)) & 0xFF;
      ...
      union {
        double real;
        uint64_t base;
      } u_stride_limitation_for_circle_typei;
      u_stride_limitation_for_circle_typei.real = this->stride_limitation_for_circle_type[i];
      *(outbuffer + offset + 0) = (u_stride_limitation_for_circle_typei.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_stride_limitation_for_circle_typei.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_stride_limitation_for_circle_typei.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_stride_limitation_for_circle_typei.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_stride_limitation_for_circle_typei.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_stride_limitation_for_circle_typei.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_stride_limitation_for_circle_typei.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_stride_limitation_for_circle_typei.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->stride_limitation_for_circle_type[i]);
      }
      union {
        int64_t real;
        uint64_t base;
      ...
      *(outbuffer + offset + 7) = (u_cycloid_delay_kick_point_offseti.base >> (8 * 7)) & 0xFF;
      ...
      union {
        double real;
        uint64_t base;
      } u_swing_trajectory_time_offset_xy2z;
      u_swing_trajectory_time_offset_xy2z.real = this->swing_trajectory_time_offset_xy2z;
      *(outbuffer + offset + 0) = (u_swing_trajectory_time_offset_xy2z.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_swing_trajectory_time_offset_xy2z.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_swing_trajectory_time_offset_xy2z.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_swing_trajectory_time_offset_xy2z.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_swing_trajectory_time_offset_xy2z.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_swing_trajectory_time_offset_xy2z.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_swing_trajectory_time_offset_xy2z.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_swing_trajectory_time_offset_xy2z.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->swing_trajectory_time_offset_xy2z);
      union {
        double real;
        uint64_t base;
      ...
      *(outbuffer + offset + 7) = (u_heel_angle.base >> (8 * 7)) & 0xFF;
      ...
      u_toe_check_thre.real = this->toe_check_thre;
      *(outbuffer + offset + 0) = (u_toe_check_thre.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_toe_check_thre.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_toe_check_thre.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_toe_check_thre.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_toe_check_thre.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_toe_check_thre.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_toe_check_thre.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_toe_check_thre.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->toe_check_thre);
      union {
        double real;
        uint64_t base;
      } u_heel_check_thre;
      u_heel_check_thre.real = this->heel_check_thre;
      *(outbuffer + offset + 0) = (u_heel_check_thre.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_heel_check_thre.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_heel_check_thre.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_heel_check_thre.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_heel_check_thre.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_heel_check_thre.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_heel_check_thre.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_heel_check_thre.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->heel_check_thre);
      ...
      *(outbuffer + offset + 3) = (u_overwritable_footstep_index_offset.base >> (8 * 3)) & 0xFF;
      ...
      union {
        double real;
        uint64_t base;
      } u_overwritable_stride_limitationi;
      u_overwritable_stride_limitationi.real = this->overwritable_stride_limitation[i];
      *(outbuffer + offset + 0) = (u_overwritable_stride_limitationi.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_overwritable_stride_limitationi.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_overwritable_stride_limitationi.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_overwritable_stride_limitationi.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_overwritable_stride_limitationi.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_overwritable_stride_limitationi.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_overwritable_stride_limitationi.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_overwritable_stride_limitationi.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->overwritable_stride_limitation[i]);
      }
      union {
        bool real;
        uint8_t base;
      ...
      *(outbuffer + offset + 7) = (u_stride_limitation_type.base >> (8 * 7)) & 0xFF;
      ...
      u_leg_margini.real = this->leg_margin[i];
      *(outbuffer + offset + 0) = (u_leg_margini.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_leg_margini.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_leg_margini.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_leg_margini.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_leg_margini.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_leg_margini.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_leg_margini.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_leg_margini.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->leg_margin[i]);
      }
      union {
        double real;
        uint64_t base;
      } u_footstep_modification_gain;
      u_footstep_modification_gain.real = this->footstep_modification_gain;
      *(outbuffer + offset + 0) = (u_footstep_modification_gain.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_footstep_modification_gain.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_footstep_modification_gain.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_footstep_modification_gain.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_footstep_modification_gain.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_footstep_modification_gain.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_footstep_modification_gain.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_footstep_modification_gain.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->footstep_modification_gain);
      union {
        bool real;
        uint8_t base;
      } u_modify_footsteps;
      ...
      *(outbuffer + offset + 7) = (u_cp_check_margini.base >> (8 * 7)) & 0xFF;
      ...
      u_margin_time_ratio.real = this->margin_time_ratio;
      *(outbuffer + offset + 0) = (u_margin_time_ratio.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_margin_time_ratio.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_margin_time_ratio.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_margin_time_ratio.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_margin_time_ratio.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_margin_time_ratio.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_margin_time_ratio.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_margin_time_ratio.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->margin_time_ratio);
      return offset;
    }
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      u_stride_limitation_for_circle_typei.base = 0;
      u_stride_limitation_for_circle_typei.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_stride_limitation_for_circle_typei.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_stride_limitation_for_circle_typei.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_stride_limitation_for_circle_typei.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_stride_limitation_for_circle_typei.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_stride_limitation_for_circle_typei.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_stride_limitation_for_circle_typei.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_stride_limitation_for_circle_typei.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->stride_limitation_for_circle_type[i] = u_stride_limitation_for_circle_typei.real;
      offset += sizeof(this->stride_limitation_for_circle_type[i]);
      }
      union {
        int64_t real;
      ...
      u_swing_trajectory_time_offset_xy2z.base = 0;
      u_swing_trajectory_time_offset_xy2z.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_swing_trajectory_time_offset_xy2z.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_swing_trajectory_time_offset_xy2z.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_swing_trajectory_time_offset_xy2z.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_swing_trajectory_time_offset_xy2z.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_swing_trajectory_time_offset_xy2z.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_swing_trajectory_time_offset_xy2z.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_swing_trajectory_time_offset_xy2z.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->swing_trajectory_time_offset_xy2z = u_swing_trajectory_time_offset_xy2z.real;
      offset += sizeof(this->swing_trajectory_time_offset_xy2z);
      union {
        double real;
        uint64_t base;
      ...
      u_toe_check_thre.base = 0;
      u_toe_check_thre.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_toe_check_thre.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_toe_check_thre.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_toe_check_thre.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_toe_check_thre.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_toe_check_thre.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_toe_check_thre.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_toe_check_thre.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->toe_check_thre = u_toe_check_thre.real;
      offset += sizeof(this->toe_check_thre);
      union {
        double real;
        uint64_t base;
      } u_heel_check_thre;
      u_heel_check_thre.base = 0;
      u_heel_check_thre.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_heel_check_thre.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_heel_check_thre.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_heel_check_thre.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_heel_check_thre.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_heel_check_thre.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_heel_check_thre.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_heel_check_thre.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->heel_check_thre = u_heel_check_thre.real;
      offset += sizeof(this->heel_check_thre);
      ...
      u_overwritable_stride_limitationi.base = 0;
      u_overwritable_stride_limitationi.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_overwritable_stride_limitationi.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_overwritable_stride_limitationi.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_overwritable_stride_limitationi.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_overwritable_stride_limitationi.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_overwritable_stride_limitationi.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_overwritable_stride_limitationi.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_overwritable_stride_limitationi.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->overwritable_stride_limitation[i] = u_overwritable_stride_limitationi.real;
      offset += sizeof(this->overwritable_stride_limitation[i]);
      }
      union {
        bool real;
      ...
      u_leg_margini.base = 0;
      u_leg_margini.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_leg_margini.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_leg_margini.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_leg_margini.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_leg_margini.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_leg_margini.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_leg_margini.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_leg_margini.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->leg_margin[i] = u_leg_margini.real;
      offset += sizeof(this->leg_margin[i]);
      }
      union {
        double real;
      ...
      u_footstep_modification_gain.base = 0;
      u_footstep_modification_gain.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_footstep_modification_gain.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_footstep_modification_gain.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_footstep_modification_gain.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_footstep_modification_gain.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_footstep_modification_gain.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_footstep_modification_gain.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_footstep_modification_gain.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->footstep_modification_gain = u_footstep_modification_gain.real;
      offset += sizeof(this->footstep_modification_gain);
      union {
        bool real;
        uint8_t base;
      ...
      u_margin_time_ratio.base = 0;
      u_margin_time_ratio.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_margin_time_ratio.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_margin_time_ratio.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_margin_time_ratio.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_margin_time_ratio.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_margin_time_ratio.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_margin_time_ratio.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_margin_time_ratio.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->margin_time_ratio = u_margin_time_ratio.real;
      offset += sizeof(this->margin_time_ratio);
     return offset;
    }
