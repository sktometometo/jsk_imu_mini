...
namespace hrpsys_ros_bridge
{
  ...
  class OpenHRP_AutoBalancerService_AutoBalancerParam : public ros::Msg
  {
    public:
      ...
      const char* additional_force_applied_link_name;
      double additional_force_applied_point_offset[3];
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 7) = (u_limb_length_margini.base >> (8 * 7)) & 0xFF;
      ...
      memcpy(outbuffer + offset, &length_additional_force_applied_link_name, sizeof(uint32_t));
      offset += 4;
      ...
      union {
        double real;
        uint64_t base;
      } u_additional_force_applied_point_offseti;
      u_additional_force_applied_point_offseti.real = this->additional_force_applied_point_offset[i];
      *(outbuffer + offset + 0) = (u_additional_force_applied_point_offseti.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_additional_force_applied_point_offseti.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_additional_force_applied_point_offseti.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_additional_force_applied_point_offseti.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_additional_force_applied_point_offseti.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_additional_force_applied_point_offseti.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_additional_force_applied_point_offseti.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_additional_force_applied_point_offseti.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->additional_force_applied_point_offset[i]);
      }
      return offset;
    }
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      memcpy(&length_additional_force_applied_link_name, (inbuffer + offset), sizeof(uint32_t));
      offset += 4;
      ...
      u_additional_force_applied_point_offseti.base = 0;
      u_additional_force_applied_point_offseti.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_additional_force_applied_point_offseti.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_additional_force_applied_point_offseti.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_additional_force_applied_point_offseti.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_additional_force_applied_point_offseti.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_additional_force_applied_point_offseti.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_additional_force_applied_point_offseti.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_additional_force_applied_point_offseti.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->additional_force_applied_point_offset[i] = u_additional_force_applied_point_offseti.real;
      offset += sizeof(this->additional_force_applied_point_offset[i]);
      }
     return offset;
    }
