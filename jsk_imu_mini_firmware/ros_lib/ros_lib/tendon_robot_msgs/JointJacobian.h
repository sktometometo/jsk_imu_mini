#ifndef _ROS_tendon_robot_msgs_JointJacobian_h
#define _ROS_tendon_robot_msgs_JointJacobian_h
...
namespace tendon_robot_msgs
{
  ...
  class JointJacobian : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "tendon_robot_msgs/JointJacobian"; };
