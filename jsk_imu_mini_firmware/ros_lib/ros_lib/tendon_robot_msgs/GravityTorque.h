#ifndef _ROS_tendon_robot_msgs_GravityTorque_h
#define _ROS_tendon_robot_msgs_GravityTorque_h
...
namespace tendon_robot_msgs
{
  ...
  class GravityTorque : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "tendon_robot_msgs/GravityTorque"; };
