#ifndef _ROS_tendon_robot_msgs_JointStiffness_h
#define _ROS_tendon_robot_msgs_JointStiffness_h
...
namespace tendon_robot_msgs
{
  ...
  class JointStiffness : public ros::Msg
  {
    ...
    const char * getType(){ return "tendon_robot_msgs/JointStiffness"; };
