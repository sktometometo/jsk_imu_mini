#ifndef _ROS_tendon_robot_msgs_MuscleStiffness_h
#define _ROS_tendon_robot_msgs_MuscleStiffness_h
...
namespace tendon_robot_msgs
{
  ...
  class MuscleStiffness : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "tendon_robot_msgs/MuscleStiffness"; };
