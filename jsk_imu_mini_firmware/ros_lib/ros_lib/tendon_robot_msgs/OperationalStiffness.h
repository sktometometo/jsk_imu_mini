#ifndef _ROS_tendon_robot_msgs_OperationalStiffness_h
#define _ROS_tendon_robot_msgs_OperationalStiffness_h
...
namespace tendon_robot_msgs
{
  ...
  class OperationalStiffness : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "tendon_robot_msgs/OperationalStiffness"; };
