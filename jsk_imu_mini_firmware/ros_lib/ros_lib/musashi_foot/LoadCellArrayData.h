#ifndef _ROS_musashi_foot_LoadCellArrayData_h
#define _ROS_musashi_foot_LoadCellArrayData_h
...
namespace musashi_foot
{
  ...
  class LoadCellArrayData : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "musashi_foot/LoadCellArrayData"; };
